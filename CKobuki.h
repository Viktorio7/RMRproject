...
public:
    ...
    static long double getTickToMeter(){return tickToMeter;}
    static long double getB(){return b;}
...
private:
    ...
    constexpr static const long double tickToMeter = 0.000085292090497737556558; // [m/tick]
    constexpr static const long double b = 0.23; // wheelbase distance in meters, from kobuki manual https://yujinrobot.github.io/kobuki/doxygen/enAppendixProtocolSpecification.html
//
